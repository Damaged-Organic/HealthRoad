  ...
  return {
    ...
    execute: function() {
      BindService = function() {
        ...
        return ($traceurRuntime.createClass)(BindService, {_send: function() {
            for (var args = [],
      ...
      $__export('default', new BindService());
    }
  };
});

$__System.register("c", ["b"], function($__export) {
  "use strict";
  var __moduleName = "c";
  var BindService,
      BindController;
  return {
    ...
    execute: function() {
      BindController = function() {
        ...
        return ($traceurRuntime.createClass)(BindController, {
          initialize: function() {
            this._events();
          ...
          handleBind: function(e) {
            ...
            this.service._send(entity, parentID, childID, isBinded, path).done(function(response) {
      ...
      $__export('default', BindController);
    }
  };
});
...
$__System.register("e", [], function($__export) {
  ...
  return {
    setters: [],
    execute: function() {
      isFileReader = window.File && window.FileReader && window.FileList && window.Blob;
      PhotoPreview = function() {
        function PhotoPreview() {
          this.initialize();
        }
        return ($traceurRuntime.createClass)(PhotoPreview, {
          initialize: function() {
            if (!isFileReader)
              return;
            this._events();
          ...
          convertToMBytes: function(bytes, mb) {
            if (bytes <= 0)
              return;
          ...
          showFile: function(src, size) {
            this.holder.find(".photo-holder").html(("\n\t\t\t<img src=\"" + src + "\" alt=\"preview\">\n\t\t\t<span class=\"size\">" + size + "</span>\n\t\t")).andSelf().addClass("active");
          }
        }, {});
      }();
      $__export('default', PhotoPreview);
    }
  };
});

$__System.register("1", ["3", "5", "7", "8", "9", "a", "c", "d", "e"], function($__export) {
  "use strict";
  var __moduleName = "1";
  var $,
      validate,
