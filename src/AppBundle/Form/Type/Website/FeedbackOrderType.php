<?php
// AppBundle/Form/Type/Website/FeedbackOrderType.php
...
class FeedbackOrderType extends AbstractType
{
    private $_translator;
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults([
            'data_class'         => 'AppBundle\Entity\Website\Feedback\FeedbackOrder',
